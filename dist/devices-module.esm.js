...
class Property extends Model {
  ...
  get analogValue() {
    ...
    if (this.device !== null && this.device.hardwareManufacturer === HardwareManufacturer.ITEAD && Object.prototype.hasOwnProperty.call(storeInstance, '$i18n')) {
      switch (this.identifier) {
        case 'air_quality':
          if (this.value > 7) {
            // @ts-ignore
            return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${this.identifier}.values.unhealthy`).toString();
          } else if (this.value > 4) {
            // @ts-ignore
            return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${this.identifier}.values.moderate`).toString();
          } // @ts-ignore


          return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${this.identifier}.values.good`).toString();

        case 'light_level':
          if (this.value > 8) {
            // @ts-ignore
            return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${this.identifier}.values.dusky`).toString();
          } else if (this.value > 4) {
            // @ts-ignore
            return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${this.identifier}.values.normal`).toString();
          } // @ts-ignore


          return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${this.identifier}.values.bright`).toString();

        case 'noise_level':
          if (this.value > 6) {
            // @ts-ignore
            return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${this.identifier}.values.noisy`).toString();
          ...
          return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${this.identifier}.values.quiet`).toString();
      }
    }
    ...
    if (this.device !== null && !this.device.isCustomModel && Object.prototype.hasOwnProperty.call(storeInstance, '$i18n')) {
      ...
      this.values.forEach(item => {
        ...
        items.push({
          value: item.value,
          // @ts-ignore
          name: storeInstance.$i18n.t(`devices.vendors.${(_this$device = this.device) === null || _this$device === void 0 ? void 0 : _this$device.hardwareManufacturer}.configuration.${this.identifier}.values.${item.name}`).toString()
        });
      });
      return items;
    }
      ...
      if (this.device !== null && !this.device.isCustomModel && Object.prototype.hasOwnProperty.call(storeInstance, '$i18n')) {
        this.values.forEach(item => {
          ...
          if (item.value == this.value) {
            ...
            // @ts-ignore
            if (!storeInstance.$i18n.t(`devices.vendors.${(_this$device2 = this.device) === null || _this$device2 === void 0 ? void 0 : _this$device2.hardwareManufacturer}.configuration.${this.identifier}.values.${item.name}`).toString().includes('devices.vendors.')) {
              var _this$device3;

              // @ts-ignore
              return storeInstance.$i18n.t(`devices.vendors.${(_this$device3 = this.device) === null || _this$device3 === void 0 ? void 0 : _this$device3.hardwareManufacturer}.configuration.${this.identifier}.values.${item.name}`);
            } else {
              return this.value;
            }
          }
  ...
  get title() {
    ...
    if (this.device !== null && !this.device.isCustomModel && Object.prototype.hasOwnProperty.call(storeInstance, '$i18n')) {
      if (this.identifier.includes('_')) {
        ...
        const propertyNum = parseInt(this.identifier.substring(this.identifier.indexOf('_') + 1), 10); // @ts-ignore
        ...
        if (!storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.devices.${this.device.hardwareModel}.properties.${propertyPart}.title`).toString().includes('devices.vendors.')) {
          // @ts-ignore
          return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.devices.${this.device.hardwareModel}.properties.${propertyPart}.title`, {
            number: propertyNum
          }).toString();
        } // @ts-ignore
        ...
        if (!storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${propertyPart}.title`).toString().includes('devices.vendors.')) {
          // @ts-ignore
          return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.properties.${propertyPart}.title`, {
            number: propertyNum
          }).toString();
        }
      } // @ts-ignore
  ...
  get title() {
    ...
    if (this.device !== null && !this.device.isCustomModel && Object.prototype.hasOwnProperty.call(storeInstance, '$i18n')) {
      if (this.identifier.includes('_')) {
        ...
        const configurationNum = parseInt(this.identifier.substring(this.identifier.indexOf('_') + 1), 10); // @ts-ignore
        ...
        if (!storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.devices.${this.device.hardwareModel}.configuration.${configurationPart}.title`).toString().includes('devices.vendors.')) {
          // @ts-ignore
          return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.devices.${this.device.hardwareModel}.configuration.${configurationPart}.title`, {
        ...
        if (!storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.configuration.${configurationPart}.title`).toString().includes('devices.vendors.')) {
          // @ts-ignore
          return storeInstance.$i18n.t(`devices.vendors.${this.device.hardwareManufacturer}.configuration.${configurationPart}.title`, {
            number: configurationNum
          }).toString();
        }
      } // @ts-ignore
  ...
  get selectValues() {
    ...
    if (this.device !== null && !this.device.isCustomModel && Object.prototype.hasOwnProperty.call(storeInstance, '$i18n')) {
      ...
      this.values.forEach(item => {
        ...
        let valueName = item.name; // @ts-ignore
        ...
        if (!storeInstance.$i18n.t(`devices.vendors.${(_this$device = this.device) === null || _this$device === void 0 ? void 0 : _this$device.hardwareManufacturer}.devices.${(_this$device2 = this.device) === null || _this$device2 === void 0 ? void 0 : _this$device2.hardwareModel}.configuration.${this.identifier}.values.${item.name}`).toString().includes('devices.vendors.')) {
          ...
          // @ts-ignore
          valueName = storeInstance.$i18n.t(`devices.vendors.${(_this$device3 = this.device) === null || _this$device3 === void 0 ? void 0 : _this$device3.hardwareManufacturer}.devices.${(_this$device4 = this.device) === null || _this$device4 === void 0 ? void 0 : _this$device4.hardwareModel}.configuration.${this.identifier}.values.${item.name}`).toString(); // @ts-ignore
        } else if (!storeInstance.$i18n.t(`devices.vendors.${(_this$device5 = this.device) === null || _this$device5 === void 0 ? void 0 : _this$device5.hardwareManufacturer}.configuration.${this.identifier}.values.${item.name}`).toString().includes('devices.vendors.')) {
          var _this$device6;

          // @ts-ignore
          valueName = storeInstance.$i18n.t(`devices.vendors.${(_this$device6 = this.device) === null || _this$device6 === void 0 ? void 0 : _this$device6.hardwareManufacturer}.configuration.${this.identifier}.values.${item.name}`).toString();
        }
        ...
        this.values.forEach(item => {
          ...
          if (item.value == this.value) {
            ...
            if (!storeInstance.$i18n.t(`devices.vendors.${(_this$device7 = this.device) === null || _this$device7 === void 0 ? void 0 : _this$device7.hardwareManufacturer}.devices.${(_this$device8 = this.device) === null || _this$device8 === void 0 ? void 0 : _this$device8.hardwareModel}.configuration.${this.identifier}.values.${item.name}`).toString().includes('devices.vendors.')) {
              ...
              // @ts-ignore
              return storeInstance.$i18n.t(`devices.vendors.${(_this$device9 = this.device) === null || _this$device9 === void 0 ? void 0 : _this$device9.hardwareManufacturer}.devices.${(_this$device10 = this.device) === null || _this$device10 === void 0 ? void 0 : _this$device10.hardwareModel}.configuration.${this.identifier}.values.${item.name}`).toString(); // @ts-ignore
            } else if (!storeInstance.$i18n.t(`devices.vendors.${(_this$device11 = this.device) === null || _this$device11 === void 0 ? void 0 : _this$device11.hardwareManufacturer}.configuration.${this.identifier}.values.${item.name}`).toString().includes('devices.vendors.')) {
              var _this$device12;

              // @ts-ignore
              return storeInstance.$i18n.t(`devices.vendors.${(_this$device12 = this.device) === null || _this$device12 === void 0 ? void 0 : _this$device12.hardwareManufacturer}.configuration.${this.identifier}.values.${item.name}`).toString();
            } else {
              return this.value;
            }
          }
  ...
  get title() {
    ...
    if (device !== null && !device.isCustomModel && Object.prototype.hasOwnProperty.call(storeInstance, '$i18n')) {
      if (this.identifier.includes('_')) {
        ...
        const channelNum = parseInt(this.identifier.substring(this.identifier.indexOf('_') + 1), 10); // @ts-ignore
        ...
        if (!storeInstance.$i18n.t(`devices.vendors.${device.hardwareManufacturer}.devices.${device.hardwareModel}.channels.${channelPart}.title`).toString().includes('devices.vendors.')) {
          // @ts-ignore
          return storeInstance.$i18n.t(`devices.vendors.${device.hardwareManufacturer}.devices.${device.hardwareModel}.channels.${channelPart}.title`, {
            number: channelNum + 1
          }).toString();
        } // @ts-ignore
        ...
        if (!storeInstance.$i18n.t(`devices.vendors.${device.hardwareManufacturer}.channels.${channelPart}.title`).toString().includes('devices.vendors.')) {
          // @ts-ignore
          return storeInstance.$i18n.t(`devices.vendors.${device.hardwareManufacturer}.channels.${channelPart}.title`, {
            number: channelNum + 1
          }).toString();
        }
      } // @ts-ignore
...
const ModuleApiPrefix = `/${ModulePrefix.MODULE_DEVICES_PREFIX}`; // STORE
// =====
...
const moduleActions$7 = {
  ...
  async add({
    ...
    const id = typeof payload.id !== 'undefined' && payload.id !== null && payload.id !== '' ? payload.id : v4().toString();
  ...
  async socketData({
    ...
    if (validate(body)) {
      ...
      if (payload.routingKey === DevicesModule.DEVICES_DELETED_ENTITY) {
        ...
        commit('SET_SEMAPHORE', {
          type: payload.routingKey === DevicesModule.DEVICES_UPDATED_ENTITY ? SemaphoreTypes.UPDATING : SemaphoreTypes.CREATING,
          id: body.id
        });
        const entityData = {};
  ...
  async socketData({
    ...
    if (validate(body)) {
      ...
      if (payload.routingKey === DevicesModule.DEVICES_PROPERTY_DELETED_ENTITY) {
        ...
        commit('SET_SEMAPHORE', {
          type: payload.routingKey === DevicesModule.DEVICES_PROPERTY_UPDATED_ENTITY ? SemaphoreTypes.UPDATING : SemaphoreTypes.CREATING,
          id: body.id
        });
        const entityData = {
  ...
  async socketData({
    ...
    if (validate(body)) {
      ...
      if (payload.routingKey === DevicesModule.DEVICES_CONFIGURATION_DELETED_ENTITY) {
        ...
        commit('SET_SEMAPHORE', {
          type: payload.routingKey === DevicesModule.DEVICES_CONFIGURATION_UPDATED_ENTITY ? SemaphoreTypes.UPDATING : SemaphoreTypes.CREATING,
          id: body.id
        });
        const entityData = {
  ...
  async socketData({
    ...
    if (validate(body)) {
      ...
      if (payload.routingKey === DevicesModule.CHANNELS_DELETED_ENTITY) {
        ...
        commit('SET_SEMAPHORE', {
          type: payload.routingKey === DevicesModule.CHANNELS_UPDATED_ENTITY ? SemaphoreTypes.UPDATING : SemaphoreTypes.CREATING,
          id: body.id
        });
        const entityData = {
  ...
  async socketData({
    ...
    if (validate(body)) {
      ...
      if (payload.routingKey === DevicesModule.CHANNELS_PROPERTY_DELETED_ENTITY) {
        ...
        commit('SET_SEMAPHORE', {
          type: payload.routingKey === DevicesModule.CHANNELS_PROPERTY_UPDATED_ENTITY ? SemaphoreTypes.UPDATING : SemaphoreTypes.CREATING,
          id: body.id
        });
        const entityData = {
  ...
  async socketData({
    ...
    if (validate(body)) {
      ...
      if (payload.routingKey === DevicesModule.CHANNELS_CONFIGURATION_DELETED_ENTITY) {
        ...
        commit('SET_SEMAPHORE', {
          type: payload.routingKey === DevicesModule.CHANNELS_CONFIGURATION_UPDATED_ENTITY ? SemaphoreTypes.UPDATING : SemaphoreTypes.CREATING,
          id: body.id
        });
        const entityData = {
...
export { ActorNameTypes, Channel, ChannelConfiguration, ChannelConfigurationEntityTypes, ChannelEntityTypes, ChannelProperty, ChannelPropertyEntityTypes, ConfigurationIntegerDatatypeTypes, ConfigurationNumberDatatypeTypes, Connector, ConnectorEntityTypes, Device, DeviceConfiguration, DeviceConfigurationEntityTypes, DeviceConnector, DeviceConnectorEntityTypes, DeviceEntityTypes, DeviceProperty, DevicePropertyEntityTypes, PropertyCommandResult, PropertyCommandState, PropertyIntegerDatatypeTypes, PropertyNumberDatatypeTypes, SensorNameTypes };
