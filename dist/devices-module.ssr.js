...
// =====
var SemaphoreTypes$7; // ENTITY TYPES
// ============
...
var DeviceEntityTypes; // ENTITY INTERFACE
// ================

(function (DeviceEntityTypes) {
  DeviceEntityTypes["DEVICE"] = "devices-module/device";
})(DeviceEntityTypes || (DeviceEntityTypes = {}));// ENTITY TYPES
// ============
var PropertyNumberDatatypeTypes;
...
var PropertyIntegerDatatypeTypes;
...
var ActorNameTypes; // ENTITY INTERFACE
// ================

(function (ActorNameTypes) {
  ActorNameTypes["ACTOR"] = "actor";
  ActorNameTypes["SWITCH"] = "switch";
})(ActorNameTypes || (ActorNameTypes = {}));// ENTITY MODEL
// ============
...
// =====
var SemaphoreTypes$6; // ENTITY TYPES
// ============
...
var DevicePropertyEntityTypes; // ENTITY INTERFACE
// ================
...
// =====
var SemaphoreTypes$5; // ENTITY TYPES
// ============
...
var DeviceConfigurationEntityTypes; // ENTITY INTERFACE
// ================
...
var ConfigurationNumberDatatypeTypes;
...
var ConfigurationIntegerDatatypeTypes; // ENTITY INTERFACE
// ================
...
// =====
var SemaphoreTypes$4; // ENTITY TYPES
// ============
...
var ChannelEntityTypes; // ENTITY INTERFACE
// ================

(function (ChannelEntityTypes) {
  ChannelEntityTypes["CHANNEL"] = "devices-module/channel";
})(ChannelEntityTypes || (ChannelEntityTypes = {}));// STORE
// =====
var SemaphoreTypes$3; // ENTITY TYPES
// ============
...
var ChannelPropertyEntityTypes; // ENTITY INTERFACE
// ================

(function (ChannelPropertyEntityTypes) {
  ChannelPropertyEntityTypes["PROPERTY"] = "devices-module/channel-property";
})(ChannelPropertyEntityTypes || (ChannelPropertyEntityTypes = {}));// ENTITY MODEL
// ============
...
// =====
var SemaphoreTypes$2; // ENTITY TYPES
// ============
...
var DeviceConnectorEntityTypes; // ENTITY INTERFACE
// ================

(function (DeviceConnectorEntityTypes) {
  DeviceConnectorEntityTypes["CONNECTOR"] = "devices-module/device-connector";
})(DeviceConnectorEntityTypes || (DeviceConnectorEntityTypes = {}));// ENTITY MODEL
// ============
...
var OrmError = /*#__PURE__*/function (_ExceptionError2) {
  ...
  return OrmError;
}(ExceptionError);// STORE
// =====
var SemaphoreTypes$1; // ENTITY TYPES
// ============
...
var ChannelConfigurationEntityTypes; // ENTITY INTERFACE
// ================
...
})(ChannelConfigurationEntityTypes || (ChannelConfigurationEntityTypes = {}));var RELATIONSHIP_NAMES_PROP = 'relationshipNames';
    ...
    value: function setRelationships(model, relationships) {
      ...
      Object.keys(relationships).forEach(function (propName) {
        ...
        if (typeof relationships[propName] === 'function') {
          ...
          } else if (get__default['default'](relation, 'type') === DeviceEntityTypes.DEVICE) {
            Object.assign(model, {
              deviceId: get__default['default'](relation, 'id')
            });
          } else if (get__default['default'](relation, 'type') === ChannelEntityTypes.CHANNEL) {
            Object.assign(model, {
...
}(Jsona.JsonPropertiesMapper);var ModuleApiPrefix = "/".concat(modulesMetadata.ModulePrefix.MODULE_DEVICES_PREFIX);var _moduleMutations$7;
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              commit = _ref3.commit;
              id = typeof payload.id !== 'undefined' && payload.id !== null && payload.id !== '' ? payload.id : uuid__default['default'].v4().toString();
      ...
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 27:
              commit('SET_SEMAPHORE', {
                type: payload.routingKey === modulesMetadata.DevicesModule.DEVICES_UPDATED_ENTITY ? SemaphoreTypes$7.UPDATING : SemaphoreTypes$7.CREATING,
                id: body.id
              });
              entityData = {};
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 27:
              commit('SET_SEMAPHORE', {
                type: payload.routingKey === modulesMetadata.DevicesModule.DEVICES_PROPERTY_UPDATED_ENTITY ? SemaphoreTypes$6.UPDATING : SemaphoreTypes$6.CREATING,
                id: body.id
              });
              entityData = {
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 27:
              commit('SET_SEMAPHORE', {
                type: payload.routingKey === modulesMetadata.DevicesModule.DEVICES_CONFIGURATION_UPDATED_ENTITY ? SemaphoreTypes$5.UPDATING : SemaphoreTypes$5.CREATING,
                id: body.id
              });
              entityData = {
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 27:
              commit('SET_SEMAPHORE', {
                type: payload.routingKey === modulesMetadata.DevicesModule.DEVICES_PROPERTY_UPDATED_ENTITY ? SemaphoreTypes$2.UPDATING : SemaphoreTypes$2.CREATING,
                id: body.id
              });
              entityData = {
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 27:
              commit('SET_SEMAPHORE', {
                type: payload.routingKey === modulesMetadata.DevicesModule.CHANNELS_UPDATED_ENTITY ? SemaphoreTypes$4.UPDATING : SemaphoreTypes$4.CREATING,
                id: body.id
              });
              entityData = {
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 27:
              commit('SET_SEMAPHORE', {
                type: payload.routingKey === modulesMetadata.DevicesModule.CHANNELS_PROPERTY_UPDATED_ENTITY ? SemaphoreTypes$3.UPDATING : SemaphoreTypes$3.CREATING,
                id: body.id
              });
              entityData = {
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 27:
              commit('SET_SEMAPHORE', {
                type: payload.routingKey === modulesMetadata.DevicesModule.CHANNELS_CONFIGURATION_UPDATED_ENTITY ? SemaphoreTypes$1.UPDATING : SemaphoreTypes$1.CREATING,
                id: body.id
              });
              entityData = {
...
// =====
var SemaphoreTypes; // ENTITY TYPES
// ============
...
var ConnectorEntityTypes; // ENTITY INTERFACE
// ================
...
})(ConnectorEntityTypes || (ConnectorEntityTypes = {}));var _moduleMutations;
...
var entry = {
  install: function install(components, options) {
