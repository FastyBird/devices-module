...
import * as exchangeEntitySchema from '@fastybird/modules-metadata/resources/schemas/devices-module/entity.channel.configuration.json'
import { ModuleOrigin, ChannelConfigurationEntity as ExchangeEntity, DevicesModule as RoutingKeys } from '@fastybird/modules-metadata'
...
import {ChannelConfigurationJsonModelInterface } from '@/lib/types'
...
const apiOptions = {
  dataTransformer: (result: AxiosResponse<ChannelConfigurationResponseInterface> | AxiosResponse<ChannelPropertiesResponseInterface>): ChannelConfigurationJsonModelInterface | Array<ChannelConfigurationJsonModelInterface> => <ChannelConfigurationJsonModelInterface | Array<ChannelConfigurationJsonModelInterface>>jsonApiFormatter.deserialize(result.data),
}
...
const moduleActions: ActionTree<ChannelConfigurationState, any> = {
