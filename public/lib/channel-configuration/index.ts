...
const apiOptions = {
  dataTransformer: (result: AxiosResponse<ChannelConfigurationResponseInterface> | AxiosResponse<ChannelConfigurationsResponseInterface>): ChannelConfigurationJsonModelInterface | Array<ChannelConfigurationJsonModelInterface> => <ChannelConfigurationJsonModelInterface | Array<ChannelConfigurationJsonModelInterface>>jsonApiFormatter.deserialize(result.data),
}
