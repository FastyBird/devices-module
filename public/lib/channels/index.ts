...
import { ModuleOrigin, ChannelControlAction, ChannelEntity as ExchangeEntity, DevicesModule as RoutingKeys } from '@fastybird/modules-metadata'
...
import { ChannelJsonModelInterface } from '@/lib/types'
