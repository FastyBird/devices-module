...
import * as exchangeEntitySchema from '@fastybird/modules-metadata/resources/schemas/devices-module/entity.device.configuration.json'
import { ModuleOrigin, DeviceConfigurationEntity as ExchangeEntity, DevicesModule as RoutingKeys } from '@fastybird/modules-metadata'
...
import { DeviceConfigurationJsonModelInterface } from '@/lib/types'
...
const apiOptions = {
  dataTransformer: (result: AxiosResponse<DeviceConfigurationResponseInterface> | AxiosResponse<DevicePropertiesResponseInterface>): DeviceConfigurationJsonModelInterface | Array<DeviceConfigurationJsonModelInterface> => <DeviceConfigurationJsonModelInterface | Array<DeviceConfigurationJsonModelInterface>>jsonApiFormatter.deserialize(result.data),
}
...
const moduleActions: ActionTree<DeviceConfigurationState, any> = {
