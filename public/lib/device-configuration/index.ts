...
const apiOptions = {
  dataTransformer: (result: AxiosResponse<DeviceConfigurationResponseInterface> | AxiosResponse<DeviceConfigurationsResponseInterface>): DeviceConfigurationJsonModelInterface | Array<DeviceConfigurationJsonModelInterface> => <DeviceConfigurationJsonModelInterface | Array<DeviceConfigurationJsonModelInterface>>jsonApiFormatter.deserialize(result.data),
}
