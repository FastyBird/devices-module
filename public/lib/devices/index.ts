...
import { ModuleOrigin, DeviceControlAction, DeviceEntity as ExchangeEntity, DevicesModule as RoutingKeys } from '@fastybird/modules-metadata'
...
import { DeviceJsonModelInterface } from '@/lib/types'
