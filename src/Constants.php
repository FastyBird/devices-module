...
final class Constants
{
	...
	public const MESSAGE_BUS_CREATED_ENTITIES_ROUTING_KEYS_MAPPING = [
		...
		DevicesModuleEntities\Devices\Configuration\Row::class    => Metadata\Constants::MESSAGE_BUS_DEVICES_CONFIGURATION_CREATED_ENTITY_ROUTING_KEY,
		...
		DevicesModuleEntities\Channels\Configuration\Row::class   => Metadata\Constants::MESSAGE_BUS_CHANNELS_CONFIGURATION_CREATED_ENTITY_ROUTING_KEY,
	...
	public const MESSAGE_BUS_UPDATED_ENTITIES_ROUTING_KEYS_MAPPING = [
		...
		DevicesModuleEntities\Devices\Configuration\Row::class    => Metadata\Constants::MESSAGE_BUS_DEVICES_CONFIGURATION_UPDATED_ENTITY_ROUTING_KEY,
		...
		DevicesModuleEntities\Channels\Configuration\Row::class   => Metadata\Constants::MESSAGE_BUS_CHANNELS_CONFIGURATION_UPDATED_ENTITY_ROUTING_KEY,
	...
	public const MESSAGE_BUS_DELETED_ENTITIES_ROUTING_KEYS_MAPPING = [
		...
		DevicesModuleEntities\Devices\Configuration\Row::class    => Metadata\Constants::MESSAGE_BUS_DEVICES_CONFIGURATION_DELETED_ENTITY_ROUTING_KEY,
		...
		DevicesModuleEntities\Channels\Configuration\Row::class   => Metadata\Constants::MESSAGE_BUS_CHANNELS_CONFIGURATION_DELETED_ENTITY_ROUTING_KEY,
