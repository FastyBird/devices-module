	...
	): MetadataDocuments\DevicesModule\ConnectorControl|null
	{
		try {
			$document = $this->cache->load(
				...
				function () use ($queryObject, &$dependencies): MetadataDocuments\DevicesModule\ConnectorControl|null {
		...
		if ($document !== null && !$document instanceof MetadataDocuments\DevicesModule\ConnectorControl) {
