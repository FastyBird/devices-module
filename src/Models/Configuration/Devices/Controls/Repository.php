	...
	): MetadataDocuments\DevicesModule\DeviceControl|null
	{
		try {
			$document = $this->cache->load(
				...
				function () use ($queryObject, &$dependencies): MetadataDocuments\DevicesModule\DeviceControl|null {
		...
		if ($document !== null && !$document instanceof MetadataDocuments\DevicesModule\DeviceControl) {
