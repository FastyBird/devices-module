 ...
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 *
 * @extends IteratorAggregate<int, MetadataEntities\Modules\DevicesModule\IDeviceAttributeEntity>
 */
interface IDeviceAttributesRepository extends Countable, IteratorAggregate
{
