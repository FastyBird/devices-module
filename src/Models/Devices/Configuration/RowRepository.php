...
final class RowRepository implements IRowRepository
{
	 ...
	 *
	 * @phpstan-var ORM\EntityRepository<Entities\Devices\Configuration\IRow>|null
	 */
	 ...
	 *
	 * @phpstan-return  ORM\EntityRepository<Entities\Devices\Configuration\IRow>
	 */
	private function getRepository(string $type = Entities\Devices\Configuration\Row::class): ORM\EntityRepository
	{
