 ...
 * @testCase
 */
final class ConnectorsV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../fixtures/Controllers/connectorsRead.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../fixtures/Controllers/connectorsUpdate.php
	 */
...
$test_case = new ConnectorsV1ControllerTest();
$test_case->run();
