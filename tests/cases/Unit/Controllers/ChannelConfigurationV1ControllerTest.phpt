 ...
 * @testCase
 */
final class ChannelConfigurationV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/channelConfigurationRead.php
	 */
...
$test_case = new ChannelConfigurationV1ControllerTest();
$test_case->run();
