 ...
 * @testCase
 */
final class DeviceConfigurationV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/deviceConfigurationRead.php
	 */
...
$test_case = new DeviceConfigurationV1ControllerTest();
$test_case->run();
