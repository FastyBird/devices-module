 ...
 * @testCase
 */
final class DeviceConnectorV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/deviceConnectorRead.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/deviceConnectorCreate.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/deviceConnectorUpdate.php
	 */
...
$test_case = new DeviceConnectorV1ControllerTest();
$test_case->run();
