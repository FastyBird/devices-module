 ...
 * @testCase
 */
final class DeviceHardwareV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/deviceHardwareRead.php
	 */
...
$test_case = new DeviceHardwareV1ControllerTest();
$test_case->run();
