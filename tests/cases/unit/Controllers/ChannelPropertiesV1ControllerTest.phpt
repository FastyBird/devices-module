...
final class ChannelPropertiesV1ControllerTest extends DbTestCase
{
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/channelPropertiesCreate.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/channelPropertiesUpdate.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/channelPropertiesDelete.php
	 */
