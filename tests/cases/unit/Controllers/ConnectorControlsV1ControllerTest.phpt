 ...
 * @testCase
 */
final class ConnectorControlsV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/connectorControlsRead.php
	 */
...
$test_case = new ConnectorControlsV1ControllerTest();
$test_case->run();
