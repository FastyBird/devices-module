 ...
 * @testCase
 */
final class DeviceChildrenV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/deviceChildrenRead.php
	 */
...
$test_case = new DeviceChildrenV1ControllerTest();
$test_case->run();
