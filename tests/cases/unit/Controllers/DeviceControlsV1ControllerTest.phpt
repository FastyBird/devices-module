 ...
 * @testCase
 */
final class DeviceControlsV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/deviceControlsRead.php
	 */
...
$test_case = new DeviceControlsV1ControllerTest();
$test_case->run();
