 ...
 * @testCase
 */
final class DeviceParentsV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/deviceParentsRead.php
	 */
...
$test_case = new DeviceParentsV1ControllerTest();
$test_case->run();
