...
return [
	...
	'readAll' => [
		...
		__DIR__ . '/responses/channel.controls.index.json',
	],
	'readAllPaging' => [
		...
		'Bearer ' . VALID_TOKEN,
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/channel.controls.index.paging.json',
	],
	'readOne' => [
		...
		'Bearer ' . VALID_TOKEN,
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/channel.controls.read.json',
	],
	'readRelationshipsChannel' => [
		...
		'Bearer ' . VALID_TOKEN,
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/channel.controls.relationships.channel.json',
	],
