...
return [
	...
	'update'       => [
		...
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.connector.update.json'),
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/device.connector.update.json',
	],
	...
	'invalidType'  => [
		'/v1/devices/69786d15-fd0c-4d9f-9378-33287c2009fa/connector',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.connector.update.invalid.type.json'),
