...
return [
	...
	//////////////////
	'create'              => [
		'/v1/devices/bf4cd870-2aac-45f0-a85e-e1cefd2d6d9a/credentials',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.credentials.create.json'),
		StatusCodeInterface::STATUS_CREATED,
		__DIR__ . '/responses/device.credentials.create.json',
	],
	...
	'createInvalidDevice' => [
		'/v1/devices/e36a2788-1ef8-4cdf-ab09-4735f191a509/credentials',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.credentials.create.json'),
	...
	'missingRequired'     => [
		'/v1/devices/bf4cd870-2aac-45f0-a85e-e1cefd2d6d9a/credentials',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.credentials.create.missing.required.json'),
		StatusCodeInterface::STATUS_UNPROCESSABLE_ENTITY,
		__DIR__ . '/responses/device.credentials.create.missing.required.json',
	],
	'invalidType'         => [
		'/v1/devices/bf4cd870-2aac-45f0-a85e-e1cefd2d6d9a/credentials',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.credentials.create.invalid.type.json'),
		StatusCodeInterface::STATUS_UNPROCESSABLE_ENTITY,
	...
	'notUnique'           => [
		'/v1/devices/bf4cd870-2aac-45f0-a85e-e1cefd2d6d9a/credentials',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.credentials.create.notUnique.json'),
		StatusCodeInterface::STATUS_UNPROCESSABLE_ENTITY,
