...
return [
	...
	'readRelationshipsDevice'        => [
		...
		'Bearer ' . VALID_TOKEN,
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/device.credentials.relationships.device.json',
	],
	...
	'readInvalidDevice'              => [
		'/v1/devices/a1036ff8-6ee8-4405-aaed-58bae0814596/credentials',
		'Bearer ' . VALID_TOKEN,
	...
	'readRelationshipsUnknownDevice' => [
		'/v1/devices/28bc0d38-2f7c-4a71-aa74-27b102f8dfc4/credentials/relationships/device',
		'Bearer ' . VALID_TOKEN,
		StatusCodeInterface::STATUS_NOT_FOUND,
		__DIR__ . '/responses/generic/notFound.json',
	],
