...
return [
	...
	'update'       => [
		...
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.credentials.update.json'),
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/device.credentials.update.json',
	],
	...
	'invalidType'  => [
		'/v1/devices/69786d15-fd0c-4d9f-9378-33287c2009fa/credentials',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.credentials.update.invalid.type.json'),
