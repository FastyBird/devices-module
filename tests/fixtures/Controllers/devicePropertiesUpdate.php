...
return [
	...
	'update' => [
		...
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.properties.update.json'),
		StatusCodeInterface::STATUS_OK,
		__DIR__ . '/responses/device.properties.update.json',
	],
	...
	'invalidType' => [
		'/v1/devices/69786d15-fd0c-4d9f-9378-33287c2009fa/properties/28bc0d38-2f7c-4a71-aa74-27b102f8df4c',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.properties.update.invalid.type.json'),
	...
	'idMismatch' => [
		'/v1/devices/69786d15-fd0c-4d9f-9378-33287c2009fa/properties/28bc0d38-2f7c-4a71-aa74-27b102f8df4c',
		'Bearer ' . VALID_TOKEN,
		file_get_contents(__DIR__ . '/requests/device.properties.update.invalid.id.json'),
