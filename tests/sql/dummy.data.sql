...
(_binary 0xBBCCCF8C33AB431BA795D7BB38B6B6DB, _binary 0x69786D15FD0C4D9F937833287C2009FA, 'dynamic', 'bLikpV', 'uptime', 'uptime', 0, 1, 'int', NULL, NULL, NULL, NULL, NULL, '2020-03-20 09:18:20', '2020-03-20 09:18:20'),
...
INSERT
IGNORE INTO `fb_devices_controls` (`control_id`, `device_id`, `control_name`, `created_at`, `updated_at`) VALUES
...
INSERT
IGNORE INTO `fb_devices_configuration` (`configuration_id`, `device_id`, `configuration_key`, `configuration_data_type`, `configuration_identifier`, `configuration_name`, `configuration_comment`, `configuration_default`, `created_at`, `updated_at`, `params`) VALUES
...
INSERT
IGNORE INTO `fb_channels` (`channel_id`, `device_id`, `channel_key`, `channel_name`, `channel_comment`, `channel_identifier`, `params`, `created_at`, `updated_at`) VALUES
(_binary 0x17C59DFA2EDD438E8C49FAA4E38E5A5E, _binary 0x69786D15FD0C4D9F937833287C2009FA, 'bLikxh', 'Channel one', NULL, 'channel-one', NULL, '2020-03-20 09:22:12', '2020-03-20 22:37:14'),
...
INSERT
IGNORE INTO `fb_channels_properties` (`property_id`, `channel_id`, `property_type`, `property_key`, `property_identifier`, `property_name`, `property_settable`, `property_queryable`, `property_data_type`, `property_unit`, `property_format`, `property_invalid`, `property_number_of_decimals`, `property_value`, `created_at`, `updated_at`) VALUES
(_binary 0xBBCCCF8C33AB431BA795D7BB38B6B6DB, _binary 0x17C59DFA2EDD438E8C49FAA4E38E5A5E, 'dynamic', 'bLikx4', 'switch', 'switch', 1, 1, 'enum', NULL, 'on,off,toggle', NULL, NULL, NULL, '2019-12-09 23:19:45', '2019-12-09 23:19:49'),
...
INSERT
IGNORE INTO `fb_channels_controls` (`control_id`, `channel_id`, `control_name`, `created_at`, `updated_at`) VALUES
...
INSERT
IGNORE INTO `fb_channels_configuration` (`configuration_id`, `channel_id`, `configuration_key`, `configuration_data_type`, `configuration_identifier`, `configuration_name`, `configuration_comment`, `configuration_default`, `created_at`, `updated_at`, `params`) VALUES
